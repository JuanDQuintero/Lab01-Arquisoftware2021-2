...
public class ValidBean implements Serializable {
    ...
    /**
     * Creates a new instance of ValidBean
     */
    ...
    private String errorExpiracion = "EEEE";
    ...
    //retorna una lista de clientes para mostrar en un datatable de JSF
     ...
     /*se crea fecha actual*/
        ...
        transaccionManager.create(trans);
        ...
        public void handleKeyEvent() {
            ...
            if (num_tarjeta.length()>=5){
                ...
                if (valor >= 11111 && valor<=22222){
                      ...
                      this.imagen="imgs/mastercard.png";
                      str="";
                }
